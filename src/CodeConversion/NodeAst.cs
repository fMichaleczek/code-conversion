...
namespace CodeConversion
{
    ...
    {
        public Attribute(string name, IEnumerable<AttributeArgument> arguments)
        {
            Arguments = arguments;
            Name = name;
			SetParent(Arguments);
        ...
        public IEnumerable<AttributeArgument> Arguments { get; set; }
        public string Name { get; set; }
    ...
    public class AttributeArgument : Node
    {
        public AttributeArgument(Node expression)
        {
            Expression = expression;
            SetParent(Expression);
        }
        public AttributeArgument(Node expression, string kind)
        {
            Expression = expression;
            Kind = kind;
            SetParent(Expression);
        ...
        public AttributeArgument(string name, Node expression)
        {
            Name = name;
            Expression = expression;
            SetParent(Expression);
    ...
    public class ClassDeclaration : Node
    {
        ...
        public ClassDeclaration(string name, IEnumerable<Node> members, IEnumerable<string> bases = null, IEnumerable<string> modifiers = null, IEnumerable<Attribute> attributes = null)
        {
            Name = name;
            Members = members;
            Bases = bases;
    ...
    public class InterfaceDeclaration : Node
    {
        ...
        public InterfaceDeclaration(string name, params Node[] members)
        {
            Name = name;
            Members = members;
            SetParent(Members);
        ...
        public InterfaceDeclaration(string name, IEnumerable<Node> members, IEnumerable<string> bases = null, IEnumerable<string> modifiers = null, IEnumerable<Attribute> attributes = null)
        {
            Name = name;
            Members = members;
            Bases = bases;
    ...
    public class Namespace : Node
    {
        ...
        public Namespace(string name, IEnumerable<Node> members, IEnumerable<Node> usings)
        {
            Name = name;
            Members = members;
            Usings = usings;
        ...
        public IEnumerable<Node> Usings { get; }
        public override void Accept(NodeVisitor visitor)
        {
    ...
    {
        public UsingDirective(Node name, Node alias)
        {
            Name = name;
            Alias = alias;
